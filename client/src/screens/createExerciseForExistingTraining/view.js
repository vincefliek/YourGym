...
class PureCreateExerciseForExistingTraining extends React.Component {
  _onDeleteSet = (setId) => {
...
export const CreateExerciseForExistingTraining = connect({
  controller,
}, ctrl => ({
  data: ctrl.getData(),
  ...
  requireData(props => ({
    ...
    PureCreateExerciseForExistingTraining,
  ),
);
